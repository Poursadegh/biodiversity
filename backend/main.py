...
cors_origins = [
    "http://localhost:3000",
    "http://127.0.0.1:3000",
    "https://biodiversity-dashboard.railway.app",  # Railway
    "https://biodiversity-dashboard.onrender.com",  # Render
    "https://biodiversity-dashboard.fly.dev",      # Fly.io
]
...
async def root():
    ...
    return {"message": "Biodiversity Dashboard API", "version": "1.0.0"}
...
async def serve_frontend(full_path: str):
    ...
    """
    # If static directory exists and we're not hitting an API endpoint
    if os.path.exists("static"):
    ...
    return {"message": "Biodiversity Dashboard API - Frontend not available"}
